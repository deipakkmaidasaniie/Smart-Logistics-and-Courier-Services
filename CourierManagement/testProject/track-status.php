 ...
 if (form.Consignment.value == "" )
		 {
            ...
            <form action="track-result.php" method="post" name="form" id="form" >
			      ...
			      <span class="gentxt">Eg: IXM53533553 </span> </div></td>
            <td valign="top"><div class="newtext" align="center"><a href="home_speedage.php"><strong>Home</strong></a></div></td>
                </tr>
              <tr bgcolor="EFEFEF">
                <td valign="top">&nbsp;</td>
              </tr>
...
<?php
//include("header_speedage.php");
//include('footer_speedage.php');
