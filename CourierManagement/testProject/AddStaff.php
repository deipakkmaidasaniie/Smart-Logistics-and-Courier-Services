...
<link href="https://fonts.googleapis.com/css?family=Kodchasan" rel="stylesheet">
    ...
    <body>
        ...
        include 'navBar1.php';
         ?>
        <div class="" id="myEmployerModal" tabindex="-1" role="dialog" aria-labelledby="myEmployerModalLabel" style="background-image:url('images/slide1.jpg'); background-size: 100% 100%; background-repeat: no-repeat;  height: 100vh;">
        <style>
