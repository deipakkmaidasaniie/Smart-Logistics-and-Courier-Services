...
.full-screen {
  ...
  background-repeat: no-repeat;
    ...
    <body>
        ...
        include 'navBar.php';
         ?>
        <div class="container-fluid" style=" background-image: url(images/bg1.jpg); background-repeat: no-repeat; background-size: 100% 100%; height: 100vh;">
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
                ...
                <div class="col-md-6" style="width:40px;height:10px;"><a href="addCourier.php" >
                    <div class="container" style="width: 100px; height: 10px;color: #fff;
    ...
    ">
                    <table>
                        <tr>
                            <td>
                            <span class="fa fa-rocket" style="  font-size: 50px; padding: 5px;"></span>
                         <h2>Book Courier</h2>
                    </div></a>
                        </td>
                    <td>
    ...
    ">
                        <span class="fa fa-book" style="  font-size: 50px; padding: 5px;"></span>
