...
<table class="container" >
	<thead>
		<tr>
			<th><h1>ID</h1></th>
            <th><h1>Consignment No</h1></th>
    		<th><h1>Sent FROM</h1></th>
			<th><h1>Sent TO</h1></th>
			<th><h1>Email</h1></th>
			<th><h1>Shipper Mobile</h1></th>
            <th><h1>Receiver Mobile</h1></th>
            <th><h1>Shipper Address</h1></th>
                            ...
                            // output data of each row
                             while($row = $appresult->fetch_assoc()) 
                                ...
                                $sname=$row['shippername'];
                                 ...
                                 $email=$row['email'];
                                  $smobile = $row['shippermobile'];
                                  $rmobile = $row['receivermobile'];
                                 $saddress=$row['shipperaddress'];
